...
> Running 'python sma.py'
python: can't open file '/opt/render/project/src/sma.py': [Errno 2] No such file or directory
==> Exited with status 2
==> Common ways to troubleshoot your deploy: https://render.com/docs/troubleshooting-deploys
==> Running 'python sma.py'
python: can't open file '/opt/render/project/src/sma.py': [Errno 2] No such file or 

gimme full code correctly works100% without remove anything just fix and give it to me full ready to use 100%
